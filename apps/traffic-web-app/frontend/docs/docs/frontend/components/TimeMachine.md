...
============================================================================
File: apps/traffic-web-app/frontend/docs/docs/frontend/components/TimeMachine.md
Module: Traffic Web App - TimeMachine Component Documentation
...
Description:
  TimeMachine component documentation for historical data navigation.
============================================================================
-->
