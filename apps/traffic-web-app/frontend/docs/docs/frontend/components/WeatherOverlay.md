...
============================================================================
File: apps/traffic-web-app/frontend/docs/docs/frontend/components/WeatherOverlay.md
Module: Traffic Web App - WeatherOverlay Component Documentation
...
Description:
  WeatherOverlay component documentation for weather visualization.
============================================================================
-->
