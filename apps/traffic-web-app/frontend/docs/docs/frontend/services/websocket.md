...
============================================================================
File: apps/traffic-web-app/frontend/docs/docs/frontend/services/websocket.md
Module: Traffic Web App - WebSocket Service Documentation
...
Description:
  Real-time bidirectional communication client with auto-reconnection.
============================================================================
*/}
