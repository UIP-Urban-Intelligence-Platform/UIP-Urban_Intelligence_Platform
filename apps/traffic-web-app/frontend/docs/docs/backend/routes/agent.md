...
============================================================================
File: apps/traffic-web-app/frontend/docs/docs/backend/routes/agent.md
Module: Traffic Web App - Agent Routes Documentation
...
Description:
  Agent routes documentation for AI agent API endpoints.
============================================================================
*/}
