...
============================================================================
File: apps/traffic-web-app/frontend/docs/docs/backend/types/index.md
Module: Traffic Web App - Backend Types Documentation
...
Description:
  TypeScript type definitions documentation for backend entities.
============================================================================
*/}
