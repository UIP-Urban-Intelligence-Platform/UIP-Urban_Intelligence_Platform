...
============================================================================
File: apps/traffic-web-app/frontend/docs/api/overview.md
Module: Traffic Web App - API Reference Overview
...
Description:
  REST API reference overview documentation for traffic web application.
============================================================================
-->
