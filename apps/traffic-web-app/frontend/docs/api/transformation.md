...
============================================================================
File: apps/traffic-web-app/frontend/docs/api/transformation.md
Module: Traffic Web App - Transformation API Reference
...
Description:
  Transformation API reference for data conversion: JSON → NGSI-LD → SOSA/SSN → RDF.
============================================================================
-->
