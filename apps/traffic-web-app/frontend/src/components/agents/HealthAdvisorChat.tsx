            ...
            <div className="relative z-10 flex flex-col h-full bg-black bg-opacity-20 backdrop-blur-sm">
                        ...
                        <div className="flex items-center space-x-3">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-300">
                                    Lời khuyên thông minh về sức khỏe và môi trường
                                </p>
                            </div>
                        </div>
                        <div className="flex items-center space-x-3">
                        ...
                        <div className="flex items-center space-x-2">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-gray-500">
                                    {userProfile.transportMode} • {userProfile.sensitivityLevel} sensitivity
                                </p>
                            </div>
                        </div>
                    ...
                    {messages.length === 0 && (
                        <div className="flex flex-col items-center justify-center h-full text-center space-y-4">
                            ...
                            <p className="text-sm text-gray-600 max-w-md">
                                Tôi là trợ lý Eco-Twin của bạn. Hỏi tôi về chất lượng không khí, thời tiết,
                                hoặc cách bảo vệ sức khỏe khi di chuyển! ☕🌧️
                            </p>
                        </div>
                    )}
                ...
                <div className="bg-white p-4 border-t border-gray-200 shadow-lg">
                    ...
                    <div className="mt-3 flex items-center space-x-2 overflow-x-auto pb-2">
                        ...
                        {[
                            { label: 'Có nên ra ngoài không?', icon: '🚶' },
                            { label: 'Thời tiết hôm nay', icon: '🌤️' },
                            { label: 'Tuyến đường sạch', icon: '🗺️' },
                            { label: 'Quán cafe gần đây', icon: '☕' }
                        ].map((quick, index) => (
                            <button
                                key={index}
