...
============================================================================
File: backend/routes/analytics.md
Module: Backend Routes - Analytics Routes
...
Description:
  Analytics Routes documentation for RESTful API endpoints for traffic
  analytics, statistics, and dashboard metrics.
============================================================================
-->
