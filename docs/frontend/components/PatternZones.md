...
============================================================================
File: frontend/components/PatternZones.md
Module: Frontend Components - PatternZones
...
Description:
  PatternZones component documentation - map layer component for
  visualizing detected traffic patterns as zones.
============================================================================
-->
