...
============================================================================
File: frontend/components/HumidityVisibilityLayer.md
Module: Frontend Components - HumidityVisibilityLayer
...
Description:
  HumidityVisibilityLayer component documentation - map layer component
  visualizing humidity and visibility conditions.
============================================================================
-->
