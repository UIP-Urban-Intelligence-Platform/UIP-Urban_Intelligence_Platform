...
============================================================================
File: frontend/components/RoutePlanner.md
Module: Frontend Components - RoutePlanner
...
Description:
  RoutePlanner component documentation - interactive route planning
  component with traffic-aware suggestions.
============================================================================
-->
