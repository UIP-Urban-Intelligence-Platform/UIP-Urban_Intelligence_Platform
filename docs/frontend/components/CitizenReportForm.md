...
============================================================================
File: frontend/components/CitizenReportForm.md
Module: Frontend Components - CitizenReportForm
...
Description:
  CitizenReportForm component documentation - allows users to submit
  traffic reports with photos, descriptions, and location data.
============================================================================
-->
