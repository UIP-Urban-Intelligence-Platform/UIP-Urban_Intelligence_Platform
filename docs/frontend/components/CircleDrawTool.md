...
============================================================================
File: frontend/components/CircleDrawTool.md
Module: Frontend Components - CircleDrawTool
...
Description:
  CircleDrawTool component documentation - interactive map tool for
  drawing circular areas to define zones or filters.
============================================================================
-->
