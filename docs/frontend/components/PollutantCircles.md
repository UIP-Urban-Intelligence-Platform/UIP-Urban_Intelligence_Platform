...
============================================================================
File: frontend/components/PollutantCircles.md
Module: Frontend Components - PollutantCircles
...
Description:
  PollutantCircles component documentation - map component displaying
  pollutant concentration levels as circular markers.
============================================================================
-->
