...
============================================================================
File: frontend/components/CitizenReportMap.md
Module: Frontend Components - CitizenReportMap
...
Description:
  CitizenReportMap component documentation - specialized map component
  for displaying and interacting with citizen reports.
============================================================================
-->
