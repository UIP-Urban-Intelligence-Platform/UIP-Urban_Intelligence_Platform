...
class Neo4jQueryAgent:
    ...
    def find_congestion_propagation(self, congestion_id: str) -> List[Dict[str, Any]]:
        """
    ...
    def find_shortest_path(
        ...
        parameters = {"camera1_id": camera1_id, "camera2_id": camera2_id}
    ...
    def find_correlated_accidents(self, accident_id: str) -> List[Dict[str, Any]]:
        """
