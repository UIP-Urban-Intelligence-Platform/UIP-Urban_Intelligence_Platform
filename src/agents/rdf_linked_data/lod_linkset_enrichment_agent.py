...
class LODLinksetEnrichmentAgent:
    ...
    def _get_default_mapping_config(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "geonames": {"radius_km": 10, "prefer_city": True},
            "dbpedia": {"type_hints": {"Camera": "Place", "RoadAccident": "Place"}},
        }
    ...
    def _enrich_entity(self, entity: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if linkset or "refCity" in entity:
            ...
            custom_context = {
                ...
                "seeAlso": {"@id": "http://schema.org/sameAs", "@type": "@id"},
                "externalLinks": {"@id": "http://schema.org/relatedLink"},
            }
