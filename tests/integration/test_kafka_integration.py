...
class TestKafkaIntegration:
    ...
    def kafka_config(self):
        """Kafka configuration."""
        return {"bootstrap_servers": "localhost:9092", "topic": "test-topic"}
    ...
    def test_produce_consume_messages(self, mock_consumer, mock_producer, kafka_config):
        ...
        consumer_instance.__iter__ = Mock(
            return_value=iter([Mock(value=json.dumps(test_message).encode("utf-8"))])
        )
